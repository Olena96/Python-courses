# Задача 2
# Візьміть задачу з минулого уроку( 3) зробіть функцію як ми робили з додаванням тільки замість двох чисел зробіть
# три числа і протестуйте її всіма трьома методами)
#
# модернізуйте її так що кожний раз коли ми її запускаємо те що ми туди передаєм та
# результат повинно записуватись в файл log.txt
...
result = add_three_numbers(4,4,5)
print(result)